...
class ExampleWindow : public Gtk::Window
{
  ...
  // this is how we create adjustments! 
  // adjustments are being initialized here and will be declared in the constructor 
...
:
    ...
    // this is for the adjustment at the top of the application
    m_adjustment( Gtk::Adjustment::create(1.0, 0.0, 101.0, 1.0, 1.0, 1.0) ),
    m_adjustment_digits( Gtk::Adjustment::create(2.0, 0.0, 5.0, 1.0, 2.0) ),
    m_adjustment_pagesize( Gtk::Adjustment::create(3.0, 1.0, 101.0) ),
